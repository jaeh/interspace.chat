...
function FloatingRoomWindow() {
  ...
  const setStartingCoordinatesX = windowKey => {
    ...
    if (windowKey === 'discord chat') {
      ...
      windowOriginX = 20
    } else if (windowKey === 'VHackathon Solidity Summit' || windowKey === 'credits') {
  ...
  const setFloatingwindowColor = windowKey => {
    ...
    if (windowKey === 'main-room') {
      ...
      bgColor = '#FCE96Add'
    } else if (windowKey === 'discord chat' && space.indexOf('main-room') > -1) {
      bgColor = '#FCE96Add'
    } else if (windowKey === 'discord chat' && space.indexOf('lobby') > -1) {
      bgColor = '#FCE96Add'
    } else if (windowKey === 'discord chat' && space.indexOf('mentor-ring') > -1) {
      bgColor = '#FCE96Add'
    } else if (
        ...
        <SpaceHeader>
          ...
          <SpaceHeaderElement className="windowKey">
            {windowKey === 'main-room' ? (
              <span>
                {windowKey}
                <RoomLink href="https://jitsi.solidity-summit.ethereum.org/main-room">🔗</RoomLink>
              </span>
            ) : windowKey === 'lobby' ? (
              <span>
                {windowKey}
                <RoomLink href="https://jitsi.solidity-summit.ethereum.org/lobby">🔗</RoomLink>
              </span>
            ) : (
              windowKey
            )}
