...
*/}
      ...
      <div className="click-zone a" onClick={() => launchFloatingSpace('Tisch1')}>
        <span className="roomName">Tisch1</span>
        <div className="click-zone-highlight a"></div>
      </div>
      <div className="click-zone b" onClick={() => launchFloatingSpace('Tisch2')}>
        <span className="roomName">Tisch2</span>
        <div className="click-zone-highlight b"></div>
      </div>
      <div className="click-zone c" onClick={() => launchFloatingSpace('Tisch3')}>
      ...
      <div className="click-zone e" onClick={() => launchFloatingSpace('Tisch5')}>
        <span className="roomName">Tisch5</span>
        <div className="click-zone-highlight e"></div>
      </div>
      <div className="click-zone f" onClick={() => launchFloatingSpace('loft.radio')}>
